                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               ...
                               <center>User Registraction</center>
                            </div>
                            <div class="card-body">
                                 <table id="datatablesSimple">
                                   <table class="table">
                                    <thead>
                                        ...
                                        <?php
                                            $i=1;
                                            $rows= mysqli_query($con,"SELECT * FROM `registration`");
                                            ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="exampleModa2" tabindex="-1" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                     <form class="" action="user_reg.php" method="POST" autocomplete="off" enctype="multipart/form-data"> 

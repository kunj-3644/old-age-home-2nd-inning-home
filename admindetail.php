                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               ...
                               <center> Admin registraction data</center>
                            </div>
                            <div class="card-body">
                                 <table id="datatablesSimple">
                                   <table class="table">
                                    <thead>
                                        ...
                                        <?php
                                            $i=1;
                                            $rows= mysqli_query($con,"SELECT * FROM `adminregister`");
                                            ?>
                                            ...
                                            <td>
                                                   <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModa2">
                                                      update
                                                    </button>&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModa3">
                                               delete
                                            </button>
                                          </td>
                                            <td>
                                            <div class="modal fade" id="exampleModa2" tabindex="-1" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabe2">Delete Product</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                     <form class="" action="table.php" method="post" autocomplete="off" enctype="multipart/form-data"> 
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="exampleModa3" tabindex="-1" aria-labelledby="exampleModalLabe3" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabe3">Delete Product</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                     <form class="" action="table.php" method="post" autocomplete="off" enctype="multipart/form-data"> 

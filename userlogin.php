                                 ...
                                 <table id="datatablesSimple">
                                   <table class="table">
                                    <thead>
                                        ...
                                        <?php
                                            $i=1;
                                            $rows= mysqli_query($con,"SELECT * FROM `userlogin`");
                                            ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="exampleModa2" tabindex="-1" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                     <form class="" action="userlogin.php" method="POST" autocomplete="off" enctype="multipart/form-data"> 
                                                     <div class="input-group mb-3">

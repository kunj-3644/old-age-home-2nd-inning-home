                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               ...
                               <center> Donation Table Data</center>
                            </div>
                            <div class="card-body">
                                 <table id="datatablesSimple">
                                   <table class="table">
                                    <thead>
                                        ...
                                        <?php
                                            $i=1;
                                            $rows= mysqli_query($con,"SELECT * FROM `donation`");
                                            ?>
                                            <?php foreach($rows as $row):?>
                                            <tr>
                                                <td><?php echo $row["name"]; ?></td>
                                                <td><?php echo $row["email"]; ?></td>
                                                <td><?php echo $row["rupess"]; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="exampleModa2" tabindex="-1" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                     <form class="" action="donation.php" method="POSt" autocomplete="off" enctype="multipart/form-data"> 
...
<?php
    ...
    {
        $name = $_POST['name'];
        $query = "DELETE FROM `donation` WHERE `name` = '$name'";
